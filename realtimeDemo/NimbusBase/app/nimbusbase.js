...
(function() {
  (function() {
    ...
    Model.extend({
      ...
      update: function(id, atts, callback) {
      ...
      destroy: function(id, callback) {
        return this.find(id).destroy(callback);
      },
    ...
    return Model.include({
      ...
      save: function(callback) {
        ...
        if (callback != null) {
          callback(this.newRecord);
        }
        this.change_callback(this.newRecord);
        return this;
      },
      change_callback: function(newRecord) {},
      setChange_callback: function(_change_callback) {
        return this.change_callback = _change_callback;
      },
      ...
      updateAttributes: function(atts, callback) {
        this.load(atts);
        if (callback != null) {
          return this.save(callback);
        } else {
